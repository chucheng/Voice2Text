...
final class AnthropicClient {
    ...
    static let revisePrompt = """
        You are editing a voice-to-text transcript generated by Whisper. The transcript may contain recognition errors, missing punctuation, incorrect word choices, and minor grammatical issues.

        Your task is to:
            1.    Correct transcription errors (misheard words, obvious mistakes).
            2.    Fix grammar and punctuation where necessary.
            3.    Improve clarity only when the meaning is clearly implied by the context.
            4.    Preserve the original meaning, tone, structure, and flow as much as possible.
            5.    Do NOT rewrite stylistically.
            6.    Do NOT summarize.
            7.    Do NOT expand or add new ideas.
            8.    Do NOT change the speaker's intent.
            9.    If a sentence is ambiguous, make the smallest possible correction without guessing new meaning.

        Output ONLY the corrected transcript. Do not include explanations, comments, or formatting.
