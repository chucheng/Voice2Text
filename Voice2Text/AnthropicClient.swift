...
final class AnthropicClient {
    ...
    static let revisePrompt = """
        You are a post-processor for voice-to-text transcripts generated by Whisper. Your PRIMARY task is to add correct punctuation.
        ...
        3. MUST add proper punctuation marks at every sentence boundary and clause boundary. Use: ，。！？、；：「」（）…
           - Every sentence MUST end with a period (。), question mark (？), or exclamation mark (！).
           - Use commas (，) between clauses within a sentence.
           - Use enumeration comma (、) between parallel items.
        ...
        For ENGLISH text:
        3. MUST add proper punctuation: periods, commas, question marks, exclamation marks, apostrophes at every sentence and clause boundary.
