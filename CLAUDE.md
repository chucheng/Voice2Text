...
**Version: 2.9.5** — Cloud API UX improvements: default base URL, updated default model, API Key last-4 hint, full error messages, enhanced debug logging; Whisper Large v3; Flash Attention; 130 automated tests.
